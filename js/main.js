/* ============================================================
   ACADEMIA RAYADOS ARISTOS — main.js
   ============================================================ */
(function () {
  'use strict';
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const phone = '528121533589';
      const text  = encodeURIComponent(
        `Hola Academia Rayados Aristos ⚽\n\nSoy *${name}*.\nMe interesa: *${interest}*.\n\n${message}`
      );
  ...
  function drawFrameWithCursor() {
    ...
    if (glowX > 0) {
      ...
      cg.addColorStop(0,   'rgba(56,189,248,0.12)');
      cg.addColorStop(0.4, 'rgba(56,189,248,0.045)');
